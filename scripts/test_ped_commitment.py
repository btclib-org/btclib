...
from btclib.pedersen_commitment import second_generator_secp256k1, pedersen_commit
...
class TestPedersenCommitment(unittest.TestCase):
    def test_ped_commitment(self):
        ...
        C_inp1 = pedersen_commit(r1, G, v1, H)
        C_inp2 = pedersen_commit(r2, G, v2, H)
        ...
        C_out1 = pedersen_commit(r3, G, v3, H)          
        C_out2 = pedersen_commit(r1+r2-r3, G, v4, H)
