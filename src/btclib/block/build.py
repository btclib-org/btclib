...
(`test/functional/test_framework/blocktools.py`) is meant to be driven
into invalid states, builds a `Tx` or a
...
def build_coinbase(
    ...
    *,
    ...
    (`test/functional/test_framework/blocktools.py`): a null-outpoint
    input committing to `height` (BIP34,
