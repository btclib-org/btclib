...
def _service_flags_from_int(services: int) -> ServiceFlags | int:
    ...
    BIP155 entry carries, both being this field wherever it appears. No
    count of the importers here: a list of names is what a later module
    has to join, where a number is one it has to notice.
    """
