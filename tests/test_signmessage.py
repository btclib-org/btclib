...
class TestSignMessage(unittest.TestCase):
    ...
    def test_ledger(self):
        ...
        pubkey = '04ae3d0d5c669ed364636e79e72abc012a33be63e537babddf56bfd393256acf6dba0fac21da6386513674573a2d7baff4375c9b6d2498383853c52f0565f97f1a'
        addr = '1J6674MtZBpfHytdNofLUX6sLHAUaG33uK'
        ...
        ecdsasig, sighash = der.deserialize(DER)
        self.assertIsNone(sighash)
        dsa._verify(msg, pubkey, DER)
        dsa._verify(msg, pubkey, ecdsasig)

        rec_flag = 27 + bytes_from_hexstring(DER)[0] - 48
        msgsig = _serialize(rec_flag, ecdsasig[0], ecdsasig[1])
