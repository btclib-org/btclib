...
class TestMnemonicDictionaries(unittest.TestCase):
    def test_electrum_wallet(self):
        ...
        eversion = 'standard'
        mnemonic = electrum_mnemonic_from_raw_entropy(raw_entropy, lang, eversion)
        entropy = int(electrum_entropy_from_mnemonic(mnemonic, lang), 2)
        self.assertLess(entropy-raw_entropy, 0xfff)

        passphrase = ''

        mprv = electrum_master_prvkey_from_mnemonic(mnemonic, passphrase, eversion)
        # TODO: compare with the mprv generated by electrum
        mprv2 = electrum_master_prvkey_from_raw_entropy(raw_entropy, passphrase, lang, eversion)
