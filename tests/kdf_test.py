...
"""Tests for the `btclib.kdf` module.
...
rule is that btclib never *chooses* SHA-1: no default, no derivation of
...
from btclib.kdf import ansi_x9_63_kdf, hkdf, hkdf_expand, hkdf_extract
