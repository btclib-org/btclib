...
#    electrum.entropy_from_mnemonic, electrum.mnemonic_from_raw_entropy, \
#    electrum.mprv_from_mnemonic, \
#    electrum.mprv_from_raw_entropy
...
class TestMnemonicDictionaries(unittest.TestCase):
    def test_wallet(self):
        ...
        eversion = 'standard'
        mnemonic = electrum.mnemonic_from_raw_entropy(
            raw_entropy, lang, eversion)
        entropy = int(electrum.entropy_from_mnemonic(mnemonic, lang), 2)
        self.assertLess(entropy-raw_entropy, 0xfff)

        passphrase = ''

        xversion = b'\x04\x88\xAD\xE4'
        mprv = electrum.mprv_from_mnemonic(
            mnemonic, passphrase, xversion)
        # TODO: compare with the mprv generated by electrum
        mprv2 = electrum.mprv_from_raw_entropy(
    ...
    def test_vectors(self):
        ...
        for test_vector in test_vectors:
            ...
            lang = "en"
            entropy = int(electrum.entropy_from_mnemonic(
