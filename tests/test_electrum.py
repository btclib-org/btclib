...
from btclib.electrum import PRV, bip32_xpub_from_xprv, \
    electrum_entropy_from_mnemonic, electrum_mnemonic_from_raw_entropy, \
    electrum_mprv_from_mnemonic, \
    electrum_mprv_from_raw_entropy
...
class TestMnemonicDictionaries(unittest.TestCase):
    def test_electrum_wallet(self):
        ...
        mprv2 = electrum_mprv_from_raw_entropy(
    ...
    def test_electrum_vectors(self):
        ...
        for test_vector in test_vectors:
            ...
            xversion = PRV[0]  #FIXME: version / xversion
            mprv = electrum_mprv_from_mnemonic(mnemonic, passphrase, xversion)
            mpub2 = bip32_xpub_from_xprv(mprv).decode()
            self.assertEqual(mpub2, mpub)

            lang = "en"
            entropy = int(electrum_entropy_from_mnemonic(mnemonic, lang), 2)
            mnem = electrum_mnemonic_from_raw_entropy(entropy, lang, version)
