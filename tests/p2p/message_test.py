...
Core through `test/functional/test_framework/p2p.py`, which builds it
in Python and reads it back -- a round trip, which is what these tests
are too. So nothing here is vendored, and
