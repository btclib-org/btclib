...
test/functional/test_framework/crypto/siphash.py: a second
implementation of SipHash-2-4 and not `btclib.hashes.siphash` under
another name. So a short id keyed on a
...
# little-endian 64-bit words of the single-SHA256 of the eighty octets
# of the header with the nonce appended, and each short id is that
# implementation's
