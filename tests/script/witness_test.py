...
def test_witness() -> None:
    """Round-trip empty and six-element stacks through both codecs."""
    witness = Witness()
...
def test_frozen() -> None:
    """Verify Witness is immutable all the way down, hence hashable."""
...
def test_dataclasses_json_dict(json_golden: JsonGolden) -> None:
    """Round-trip a parsed witness's dict, held to the committed json."""
    ...
    json_golden("witness.json", witness_dict)
