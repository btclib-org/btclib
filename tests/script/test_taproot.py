...
`wallet-test-vectors.json`, while `tapscript_test_vector.json` is
`unit_test_data/script_assets_test.json` of bitcoin-core/qa-assets, a dump
generated by Core rather than anything a BIP publishes.
