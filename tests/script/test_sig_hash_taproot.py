...
- `tapscript_test_vector.json` is *not* in a BIP. It is
  `unit_test_data/script_assets_test.json` of bitcoin-core/qa-assets,
  generated by Core's `test/functional/feature_taproot.py --dumptests`,
  which is why bip-0341 does not lead to it.
