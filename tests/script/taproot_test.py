...
# the modular square root the lift of an x takes, where ellipticcurves'
# group law calls it: what the tests counting roots patch
_EC_CURVE_GROUP_ROOT = "ellipticcurves.curves.curve_group.mod_sqrt_var"
...
def test_the_python_output_key_lifts_the_internal_x_once(
    ...
    # ellipticcurves' own, where the lift takes its root: the arithmetic
