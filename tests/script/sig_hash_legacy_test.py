...
def test_first_transaction() -> None:
    """Reproduce the sig hash of block 170's transaction, the first spend."""
...
def test_legacy_p2pkh() -> None:
    """Verify a mainnet p2pkh spend's sig hash against its signature."""
...
def test_p2pk() -> None:
    """Reproduce python-bitcoinlib's p2pk test case."""
...
def test_p2pkh() -> None:
    """Reproduce python-bitcoinlib's p2pkh test case."""
...
def test_p2pk_anyonecanpay() -> None:
    """Reproduce python-bitcoinlib's p2pk ANYONECANPAY test case."""
...
def test_sig_hashsingle_bug() -> None:
    """Reproduce python-bitcoinlib's SIGHASH_SINGLE bug test case."""
...
def test_test_vectors(
    ...
    """Reproduce Core's sighash.json over undefined hash types."""
