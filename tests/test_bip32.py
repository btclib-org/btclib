...
class TestBIP32(unittest.TestCase):
    ...
    def test_bip32_vector2(self):
        ...
        mprv = bip32_master_prvkey_from_seed(seed, xkey_version)
        self.assertEqual(mprv, b"xprv9s21ZrQH143K31xYSDQpPDxsXRTUcvj2iNHm5NUtrGiGG5e2DtALGdso3pGz6ssrdK4PFmM8NSpSBHNqPqm55Qn3LqFtT2emdEXVYsCzC2U")
        mpub = bip32_xpub_from_xprv(mprv) # neutering
        self.assertEqual(mpub, b"xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB")
        xprv = mprv
        xpub = mpub
        ...
        xprv = bip32_derive(mprv, "m/0/2147483647H/1/2147483646H") # private absolute
        self.assertEqual(xprv, b"xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc")
        xpub = bip32_xpub_from_xprv(xprv) # neutering
        ...
        xprv = bip32_derive(mprv, "m/0/2147483647H/1/2147483646H/2") # private absolute
        self.assertEqual(xprv, b"xprvA2nrNbFZABcdryreWet9Ea4LvTJcGsqrMzxHx98MMrotbir7yrKCEXw7nadnHM8Dq38EGfSh6dqA9QWTyefMLEcBYJUuekgW4BYPJcr9E7j")
        xpub = bip32_derive(xpub, "./2") # public relative
