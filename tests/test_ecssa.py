...
class TestEcssa(unittest.TestCase):
    ...
    def test_ecssa(self):
        ...
        _ecssa_verify(ssasig, msg, Q, ec, sha256)
    ...
    def test_schnorr_bip_tv(self):
        ...
        e = sha256(sig[0].to_bytes(32, byteorder="big") + point2octets(ec, pub, True) + msg).digest()
    ...
    def test_batch_validation(self):
        ...
        self.assertTrue(ecssa_batch_validation(sig, m, Q, a, ec, sha256))

        m.append(m[0])
        sig.append(sig[1])  # invalid
        Q.append(Q[0])
        a.append(a[0])
        self.assertFalse(ecssa_batch_validation(sig, m, Q, a, ec, sha256))
