...
KEYWORD_ONLY: dict[str, list[str]] = {
    ...
    "btclib.psbt.frost:nonce_gen": ["leaf_hash", "extra_in"],
    "btclib.psbt.frost:partial_sig_verify": ["leaf_hash"],
    "btclib.psbt.frost:partial_sign": ["leaf_hash"],
    "btclib.psbt.frost:partial_sigs_agg": ["leaf_hash"],
    "btclib.psbt.frost:session_context": ["leaf_hash"],
