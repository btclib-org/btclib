...
__h = 1
secp112r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 56, True)
...
__h = 4
secp112r2 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 56, False)
...
__h = 1
secp128r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 64, True)
...
__h = 4
secp128r2 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 64, False)
...
__h = 1
secp160k1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 80, True)
...
__h = 1
secp160r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 80, True)
...
__h = 1
secp160r2 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 80, True)
...
__h = 1
secp192k1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 96, True)
...
__h = 1
secp192r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 96, True)
...
__h = 1
secp224k1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 112, True)
...
__h = 1
secp224r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 112, True)
...
__h = 1
secp256k1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 128, True)
...
__h = 1
secp256r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 128, True)
...
__h = 1
secp384r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 192, True)
...
__h = 1
secp521r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 256, True)

# test curves: very low cardinality

ec13_11 = Curve(13, 7, 6, Point(1,   1),  11, 1, 0, False)
ec13_19 = Curve(13, 0, 2, Point(1,   9),  19, 1, 0, False)
ec17_13 = Curve(17, 6, 8, Point(0,  12),  13, 2, 0, False)
ec17_23 = Curve(17, 3, 5, Point(1,  14),  23, 1, 0, False)
ec19_13 = Curve(19, 0, 2, Point(4,  16),  13, 2, 0, False)
ec19_23 = Curve(19, 2, 9, Point(0,  16),  23, 1, 0, False)
ec23_19 = Curve(23, 9, 7, Point(5,   4),  19, 1, 0, False)
ec23_31 = Curve(23, 5, 1, Point(0,   1),  31, 1, 0, False)
...
__Gx = 0x188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012
__Gy = 0x07192b95ffc8da78631011ed6b24cdd573f977a11e794811
nistp192 = Curve(__p, __p-3, __b, Point(__Gx, __Gy), __n, 1, 96, True)
...
__Gx = 0xb70e0cbd6bb4bf7f321390b94a03c1d356c21122343280d6115c1d21
__Gy = 0xbd376388b5f723fb4c22dfe6cd4375a05a07476444d5819985007e34
nistp224 = Curve(__p, __p-3, __b, Point(__Gx, __Gy), __n, 1, 112, True)
...
__Gx = 0x6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296
__Gy = 0x4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5
nistp256 = Curve(__p, __p-3, __b, Point(__Gx, __Gy), __n, 1, 128, True)
...
__Gx = 0xaa87ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f741e082542a385502f25dbf55296c3a545e3872760ab7
__Gy = 0x3617de4a96262c6f5d9e98bf9292dc29f8f41dbd289a147ce9da3113b5f0b8c00a60b1ce1d7e819d7a431d7c90ea0e5f
nistp384 = Curve(__p, __p-3, __b, Point(__Gx, __Gy), __n, 1, 192, True)
...
nistp521 = Curve(__p, __p-3, __b, Point(__Gx, __Gy), __n, 1, 256, True)
...
__h = 1
bpp160r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 80, True)
...
__h = 1
bpp192r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 96, True)
...
__h = 1
bpp224r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 112, True)
...
__h = 1
bpp256r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 128, True)
...
__h = 1
bpp320r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 160, True)
...
__h = 1
bpp384r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 192, True)
...
__h = 1
bpp512r1 = Curve(__p, __a, __b, Point(__Gx, __Gy), __n, __h, 256, True)
