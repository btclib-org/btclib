...
from btclib.transactions import Transaction, TxIn, TxOut
...
def test_coinbase_1():
    ...
    tx_out = TxOut.from_bytes(block_1_coinbase_output_bytes)
    ...
    assert tx_out.to_bytes() == block_1_coinbase_output_bytes
