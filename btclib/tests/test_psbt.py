...
def test_creation() -> None:
    ...
    assert Psbt.b64decode(psbt_string).b64encode() == psbt_string
    ...
    assert psbt.b64encode() == psbt_string
...
def test_psbt_combination() -> None:
    ...
    assert Psbt.b64decode(combined_psbt_string).b64encode() == combined_psbt_string

    psbt1 = Psbt.b64decode(
    ...
    assert combined_psbt.b64encode() == combined_psbt_string
...
def test_finalize() -> None:
    ...
    assert Psbt.b64decode(finalized_psbt_string).b64encode() == finalized_psbt_string
    ...
    assert finalized_psbt.b64encode() == finalized_psbt_string
...
def test_extraction() -> None:
    ...
    psbt = Psbt.b64decode(psbt_string)
    assert psbt.b64encode() == psbt_string
    tx = extract_tx(psbt)
...
def test_lexicographic_ordering() -> None:
    ...
    combined_psbt = combine_psbts([psbt1, psbt2])
    assert combined_psbt.b64encode() == combined_psbt_string
    assert combined_psbt == Psbt.b64decode(combined_psbt_string)
...
def test_explicit_version() -> None:
    ...
    with pytest.raises(BTClibValueError):
        psbt.b64encode()
    with pytest.raises(BTClibValueError):
        Psbt.b64decode(psbt.b64encode(assert_valid))
...
def test_additional_combination() -> None:
    ...
    psbt_1 = Psbt.b64decode(psbt_string)
    psbt_2 = Psbt.b64decode(psbt_string)
...
def test_sig_type1() -> None:
    ...
    psbt = Psbt.b64decode(psbt_template)
    pk1 = bytes.fromhex(
    ...
    assert psbt.b64encode() == psbt_check_string
...
def test_dataclasses_json_dict() -> None:
    ...
    # dataclass
    psbt_data = Psbt.b64decode(psbt_encoded)
