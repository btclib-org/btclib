...
def test_missing_tx():
    ...
    with pytest.raises(ValueError, match="A transaction must have at least one input"):
...
def test_psbt_json():
    ...
    psbt.to_json()
    # need to solve dataclass to json for Dict[str, bytes]
    # psbt2 = Psbt.from_json(psbt.to_json())
    # assert psbt == psbt2
...
def test_proprietary_types():
    ...
    psbt.add_unknown("abcd", "123456")
    psbt.inputs[0].add_unknown(bytes.fromhex("abcd"), "123456")
