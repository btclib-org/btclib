...
# from importlib.metadata: the value should not depend on whether btclib
# happens to be installed in the environment building the documentation
# (btclib-org/.github#1098)
...
#   link to
# - a name under ellipticcurves' own path that the pages here document
...
#   docstrings, and ellipticcurves.readthedocs.io serves no objects.inv
...
nitpick_ignore = [
    ...
    ("py:class", "ellipticcurves.alias.HashObject"),
    ("py:mod", "ellipticcurves.ecc.dh"),
    ("py:func", "ellipticcurves.ecc.dh.diffie_hellman"),
]
